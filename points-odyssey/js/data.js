...
export const STRATEGY_TIPS = {
  consultant:
    'Transfer Chase → United, fly ticket origins first, then destinations. Ticket bonuses stack.',
  family:
    'Fund Hyatt/Marriott, fly to signature hotels, book stays — hotels are your scoreboard.',
  nomad:
    'First flight each turn is cheap. Visit new cities for VP and finish ordered tickets.',
  foodie:
    'Dining earns extra bank points each turn. Transfer Amex → Delta/Hilton and travel.',
  landlord:
    'Rent on Bilt earns hard; transfer to United/American/Hyatt and race public goals.',
  executive:
    'Open premium cards for fat signups, then hotel hops for client-stay VP.',
};
...
/**
 * Skills tuned so themed kits stay distinct but avg VP is closer in bot sims.
 */
export const CHARACTERS = [
  {
    ...
    specialDesc:
      'All award flights cost 15% fewer miles. Completing a private trip ticket grants +3 bonus VP (+1 on race goals).',
    spendProfile: {
      travel: 35,
      dining: 25,
      flights: 15,
  ...
  },
  {
    ...
    cardLimitBonus: 0,
    special: 'group_rate',
    specialDesc: 'Hotel award nights cost 15% fewer points and grant +1 bonus VP per stay.',
    spendProfile: {
      groceries: 35,
      gas: 20,
      dining: 15,
  ...
  },
  {
    ...
    specialDesc:
      'First flight each turn costs 20% fewer miles. +1 VP the first time you land in a new city.',
    spendProfile: {
      transit: 30,
      travel: 25,
      dining: 15,
  ...
  },
  {
    ...
    special: 'rent_day',
    specialDesc:
      'Bilt earn +35% always (stacks with Rent Day events). Rent spend on Bilt earns at least 2× before that boost.',
    spendProfile: {
      rent: 50,
      dining: 15,
      everything: 12,
  ...
  },
  {
    ...
    special: 'extra_card',
    specialDesc:
      'Hold up to 3 cards (others 2). Signup bonuses +30% larger. Start with a $12k Chase travel fund. Each hotel stay +3 VP (client travel).',
    spendProfile: {
      flights: 25,
      hotels: 25,
      dining: 20,
...
function attachHotels() {
  const H = {
    NYC: [
      { id: 'nyc-hyatt', icon: 'assets/hotels/icons/nyc-hyatt.jpg', name: 'Park Hyatt New York', brand: 'hyatt', cost: 45000, vp: 4 },
      { id: 'nyc-marriott', icon: 'assets/hotels/icons/nyc-marriott.jpg', name: 'New York Marriott Marquis', brand: 'marriott', cost: 40000, vp: 3 },
      { id: 'nyc-hilton', icon: 'assets/hotels/icons/nyc-hilton.jpg', name: 'New York Hilton Midtown', brand: 'hilton', cost: 35000, vp: 3 },
    ],
    BOS: [
      { id: 'bos-marriott', icon: 'assets/hotels/icons/bos-marriott.jpg', name: 'Boston Marriott Copley', brand: 'marriott', cost: 35000, vp: 3 },
      { id: 'bos-hilton', icon: 'assets/hotels/icons/bos-hilton.jpg', name: 'Hilton Boston Back Bay', brand: 'hilton', cost: 32000, vp: 3 },
    ],
    WAS: [
      { id: 'was-hyatt', icon: 'assets/hotels/icons/was-hyatt.jpg', name: 'Park Hyatt Washington', brand: 'hyatt', cost: 40000, vp: 4 },
      { id: 'was-marriott', icon: 'assets/hotels/icons/was-marriott.jpg', name: 'JW Marriott Washington', brand: 'marriott', cost: 38000, vp: 3 },
      { id: 'was-hilton', icon: 'assets/hotels/icons/was-hilton.jpg', name: 'Hilton Washington DC', brand: 'hilton', cost: 30000, vp: 3 },
    ],
    ATL: [
      { id: 'atl-marriott', icon: 'assets/hotels/icons/atl-marriott.jpg', name: 'Atlanta Marriott Marquis', brand: 'marriott', cost: 32000, vp: 3 },
      { id: 'atl-hilton', icon: 'assets/hotels/icons/atl-hilton.jpg', name: 'Hilton Atlanta', brand: 'hilton', cost: 28000, vp: 2 },
    ],
    MIA: [
      { id: 'mia-hyatt', icon: 'assets/hotels/icons/mia-hyatt.jpg', name: 'Hyatt Regency Miami', brand: 'hyatt', cost: 35000, vp: 3 },
      { id: 'mia-marriott', icon: 'assets/hotels/icons/mia-marriott.jpg', name: 'Miami Marriott Biscayne', brand: 'marriott', cost: 34000, vp: 3 },
      { id: 'mia-hilton', icon: 'assets/hotels/icons/mia-hilton.jpg', name: 'Hilton Miami Downtown', brand: 'hilton', cost: 30000, vp: 3 },
    ],
    ORD: [
      { id: 'ord-hyatt', icon: 'assets/hotels/icons/ord-hyatt.jpg', name: 'Park Hyatt Chicago', brand: 'hyatt', cost: 42000, vp: 4 },
      { id: 'ord-marriott', icon: 'assets/hotels/icons/ord-marriott.jpg', name: 'Chicago Marriott Downtown', brand: 'marriott', cost: 36000, vp: 3 },
      { id: 'ord-hilton', icon: 'assets/hotels/icons/ord-hilton.jpg', name: 'Hilton Chicago', brand: 'hilton', cost: 32000, vp: 3 },
    ],
    MSP: [
      { id: 'msp-marriott', icon: 'assets/hotels/icons/msp-marriott.jpg', name: 'Minneapolis Marriott City Center', brand: 'marriott', cost: 30000, vp: 3 },
      { id: 'msp-hilton', icon: 'assets/hotels/icons/msp-hilton.jpg', name: 'Hilton Minneapolis', brand: 'hilton', cost: 28000, vp: 2 },
    ],
    DFW: [
      { id: 'dfw-hyatt', icon: 'assets/hotels/icons/dfw-hyatt.jpg', name: 'Grand Hyatt DFW', brand: 'hyatt', cost: 32000, vp: 3 },
      { id: 'dfw-marriott', icon: 'assets/hotels/icons/dfw-marriott.jpg', name: 'Dallas Marriott City Center', brand: 'marriott', cost: 30000, vp: 3 },
      { id: 'dfw-hilton', icon: 'assets/hotels/icons/dfw-hilton.jpg', name: 'Hilton Anatole Dallas', brand: 'hilton', cost: 28000, vp: 2 },
    ],
    IAH: [
      { id: 'iah-marriott', icon: 'assets/hotels/icons/iah-marriott.jpg', name: 'Houston Marriott Medical Center', brand: 'marriott', cost: 30000, vp: 3 },
      { id: 'iah-hilton', icon: 'assets/hotels/icons/iah-hilton.jpg', name: 'Hilton Americas-Houston', brand: 'hilton', cost: 28000, vp: 2 },
    ],
    DEN: [
      { id: 'den-hyatt', icon: 'assets/hotels/icons/den-hyatt.jpg', name: 'Hyatt Regency Denver', brand: 'hyatt', cost: 34000, vp: 3 },
      { id: 'den-marriott', icon: 'assets/hotels/icons/den-marriott.jpg', name: 'Denver Marriott Tech Center', brand: 'marriott', cost: 30000, vp: 3 },
      { id: 'den-hilton', icon: 'assets/hotels/icons/den-hilton.jpg', name: 'Hilton Denver City Center', brand: 'hilton', cost: 28000, vp: 2 },
    ],
    PHX: [
      { id: 'phx-marriott', icon: 'assets/hotels/icons/phx-marriott.jpg', name: 'Phoenix Marriott Tempe', brand: 'marriott', cost: 28000, vp: 2 },
      { id: 'phx-hilton', icon: 'assets/hotels/icons/phx-hilton.jpg', name: 'Hilton Phoenix Tapatio Cliffs', brand: 'hilton', cost: 26000, vp: 2 },
    ],
    LAS: [
      { id: 'las-hyatt', icon: 'assets/hotels/icons/las-hyatt.jpg', name: 'Park MGM (Hyatt)', brand: 'hyatt', cost: 30000, vp: 3 },
      { id: 'las-marriott', icon: 'assets/hotels/icons/las-marriott.jpg', name: 'JW Marriott Las Vegas', brand: 'marriott', cost: 32000, vp: 3 },
      { id: 'las-hilton', icon: 'assets/hotels/icons/las-hilton.jpg', name: 'Hilton Grand Vacations Las Vegas', brand: 'hilton', cost: 28000, vp: 2 },
    ],
    LAX: [
      { id: 'lax-hyatt', icon: 'assets/hotels/icons/lax-hyatt.jpg', name: 'Hyatt Regency LAX', brand: 'hyatt', cost: 36000, vp: 3 },
      { id: 'lax-marriott', icon: 'assets/hotels/icons/lax-marriott.jpg', name: 'Los Angeles Marriott Burbank', brand: 'marriott', cost: 34000, vp: 3 },
      { id: 'lax-hilton', icon: 'assets/hotels/icons/lax-hilton.jpg', name: 'Hilton Los Angeles Airport', brand: 'hilton', cost: 30000, vp: 3 },
    ],
    SFO: [
      { id: 'sfo-hyatt', icon: 'assets/hotels/icons/sfo-hyatt.jpg', name: 'Grand Hyatt San Francisco', brand: 'hyatt', cost: 40000, vp: 4 },
      { id: 'sfo-marriott', icon: 'assets/hotels/icons/sfo-marriott.jpg', name: 'San Francisco Marriott Marquis', brand: 'marriott', cost: 38000, vp: 3 },
    ],
    SEA: [
      { id: 'sea-hyatt', icon: 'assets/hotels/icons/sea-hyatt.jpg', name: 'Hyatt at Olive 8 Seattle', brand: 'hyatt', cost: 36000, vp: 3 },
      { id: 'sea-marriott', icon: 'assets/hotels/icons/sea-marriott.jpg', name: 'Seattle Marriott Waterfront', brand: 'marriott', cost: 34000, vp: 3 },
      { id: 'sea-hilton', icon: 'assets/hotels/icons/sea-hilton.jpg', name: 'Hilton Seattle', brand: 'hilton', cost: 30000, vp: 3 },
    ],
    MSY: [
      { id: 'msy-marriott', icon: 'assets/hotels/icons/msy-marriott.jpg', name: 'New Orleans Marriott', brand: 'marriott', cost: 32000, vp: 3 },
      { id: 'msy-hilton', icon: 'assets/hotels/icons/msy-hilton.jpg', name: 'Hilton New Orleans Riverside', brand: 'hilton', cost: 30000, vp: 3 },
    ],
  };
