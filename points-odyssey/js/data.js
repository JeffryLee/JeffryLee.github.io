...
export const CHARACTERS = [
  ...
  },
  {
    ...
    skills: [
      ...
      '+1 VP per newly visited city when you land there',
      'Private tickets grant +1 bonus VP',
    ],
    specialDesc:
      'First flight each turn costs 30% fewer miles. +1 VP per newly visited city when you land there. Completing a private ticket grants +1 bonus VP.',
    spendProfile: {
      transit: 28,
      travel: 26,
      dining: 14,
...
export const TRIP_TICKETS = [
  { id: 't1', from: 'NYC', to: 'LAX', points: 14, penalty: 5 },
  { id: 't2', from: 'SEA', to: 'MIA', points: 16, penalty: 5 },
  { id: 't3', from: 'BOS', to: 'DEN', points: 11, penalty: 4 },
  { id: 't4', from: 'ATL', to: 'SFO', points: 14, penalty: 5 },
  { id: 't5', from: 'ORD', to: 'MIA', points: 11, penalty: 4 },
  { id: 't6', from: 'SEA', to: 'NYC', points: 14, penalty: 5 },
  { id: 't7', from: 'LAX', to: 'BOS', points: 14, penalty: 5 },
  { id: 't8', from: 'DFW', to: 'SEA', points: 13, penalty: 4 },
  { id: 't9', from: 'MSP', to: 'MIA', points: 11, penalty: 4 },
  { id: 't10', from: 'DEN', to: 'MIA', points: 13, penalty: 4 },
  { id: 't11', from: 'SFO', to: 'ATL', points: 14, penalty: 5 },
  { id: 't12', from: 'PHX', to: 'NYC', points: 13, penalty: 4 },
  { id: 't13', from: 'LAS', to: 'BOS', points: 13, penalty: 4 },
  { id: 't14', from: 'IAH', to: 'SEA', points: 13, penalty: 4 },
  { id: 't15', from: 'MSY', to: 'SFO', points: 13, penalty: 4 },
  { id: 't16', from: 'WAS', to: 'LAX', points: 13, penalty: 4 },
  { id: 't17', from: 'BOS', to: 'LAX', points: 14, penalty: 5 },
  { id: 't18', from: 'ORD', to: 'SEA', points: 11, penalty: 4 },
  { id: 't19', from: 'ATL', to: 'LAS', points: 10, penalty: 3 },
  { id: 't20', from: 'NYC', to: 'MSY', points: 10, penalty: 3 },
  { id: 't21', from: 'DEN', to: 'NYC', points: 11, penalty: 4 },
  { id: 't22', from: 'SFO', to: 'MIA', points: 16, penalty: 5 },
  { id: 't23', from: 'MSP', to: 'LAX', points: 11, penalty: 4 },
  { id: 't24', from: 'WAS', to: 'SEA', points: 14, penalty: 5 },
  { id: 't25', from: 'DFW', to: 'BOS', points: 11, penalty: 4 },
  { id: 't26', from: 'PHX', to: 'ATL', points: 11, penalty: 4 },
  { id: 't27', from: 'LAS', to: 'MIA', points: 13, penalty: 4 },
  { id: 't28', from: 'ORD', to: 'LAX', points: 11, penalty: 4 },
  { id: 't29', from: 'BOS', to: 'MIA', points: 11, penalty: 4 },
  { id: 't30', from: 'SEA', to: 'DFW', points: 13, penalty: 4 },
  { id: 't31', from: 'NYC', to: 'BOS', points: 6, penalty: 2 },
  { id: 't32', from: 'NYC', to: 'WAS', points: 6, penalty: 2 },
  { id: 't33', from: 'LAX', to: 'LAS', points: 6, penalty: 2 },
  { id: 't34', from: 'LAX', to: 'SFO', points: 6, penalty: 2 },
  { id: 't35', from: 'ORD', to: 'MSP', points: 6, penalty: 2 },
  { id: 't36', from: 'ATL', to: 'MIA', points: 8, penalty: 3 },
  { id: 't37', from: 'DFW', to: 'IAH', points: 6, penalty: 2 },
  { id: 't38', from: 'DEN', to: 'PHX', points: 8, penalty: 3 },
  { id: 't39', from: 'SEA', to: 'SFO', points: 8, penalty: 3 },
  { id: 't40', from: 'WAS', to: 'ATL', points: 8, penalty: 3 },
];
